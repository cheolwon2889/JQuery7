...
<script type="text/javascript">
	$(document).ready(function(){
		...
		// $('h2').css('color','orange').css('font-size','80px');
		
		// 선택자 : 전체 , 태그 선택자, id선택자, class 선택자
		$('*').css('color','red');
		...
		// 토글
		/* $('h2').click(function(){
			// 현재 h2 태그의 color색상의 값이 넘어올껀데.
			// h2태그는 여러개 이니깐. 마지막 태그 색상은 yellow 값이 넘어오지 않을까 생각중.
			// green 값이 넘어오네.
			var color = $('h2').css('color');
			console.log(color, "현재 컬러색상.");
			
			if(color =='rgb(255, 0, 0)'){
				$('h2').css('color' , 'blue');
				console.log('blue 로 변경');
			}else {			
				$('h2').css('color' , 'red');
				console.log('red 로 변경');
			}
				console.log(color);
		}); */
...
<body>
	...
	<h2 id="t1"> 제목 1-1</h2>
	<h2 id="t1"> 제목 1-2</h2>
	<h2 class="t2"> 제목 2-1</h2>
	<h2 class="t2"> 제목 2-2</h2>
	<h3> 제목 3</h3>
